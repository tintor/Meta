...
public class XArrays {
	...
	public static <T extends Comparable<T>> T[] sort(final T[] source, final int start, final int end) {
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] fromIterator(final Iterator<T> it) {
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] sub(final T[] a, final int s, final int e) {
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] join(final T[] a, final T[] b) {
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] join(final T[]... a) {
		int len = 0;
		for (final T[] i : a)
			len = i.length;
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] filter(final T[] a) {
		int c = 0;
		for (final T e : a)
			if (e != null) c++;
	...
	@SuppressWarnings("unchecked")
	public static <T> T[] resize(final T[] a, final int size, final T def) {

package tintor.devel.index.sandbox;
...
public final class BPlusTreeFastCopy {
	...
	// Create new B+ Tree
	public BPlusTreeFastCopy(final String fileName, final int order) {
	...
	public static void basicTest() {
		final BPlusTreeFastCopy tree = new BPlusTreeFastCopy("bplus.tree", 3);
		...
		for (final BPlusTreeFastCopy.Iterator it = tree.iterator(); it.valid(); it.next())
	...
	public static void putLoadTest() {
		...
		timer.restart();
		final BPlusTreeFastCopy tree = new BPlusTreeFastCopy("bplus.tree", 20);

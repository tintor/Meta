...
public class XArraysTest {
	...
	@Test
	public void insertionSortTArrayInt() {
		fail("Not yet implemented");
	}

	@Test
	public void insertionSortTArray() {
		fail("Not yet implemented");
	}
	...
	public void sortedReplace() {
		...
		XArrays.sortedReplace(a, 2, 6);
		assertArrayEquals(a, new Integer[] { 1, 3, 4, 5, 6 });

		XArrays.sortedReplace(a, 6, 4);
		assertArrayEquals(a, new Integer[] { 1, 3, 4, 4, 5 });

		final Integer[] b = { 5 };
		XArrays.sortedReplace(b, 5, 6);
		assertArrayEquals(b, new Integer[] { 6 });
	}
	...
	@Test
	public void joinTArrayTArray() {
		fail("Not yet implemented");
	}

	@Test
	public void joinTArrayArray() {
		fail("Not yet implemented");
	}
	...
	@Test
	public void resizeTArrayInt() {
		fail("Not yet implemented");
	}

	@Test
	public void resizeTArrayIntT() {
		fail("Not yet implemented");
	}
